        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    Tabel Data Gejala
                    <a style="float: right;" href="<?= base_url('Gejala/tambahGejala'); ?>" class="btn btn-success"><b>Tambah Data</b></a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $g) : ?>
                                <tr>
                                    ...
                                    <td><?= $g->nama_gejala; ?></td>
                                    <td>
                                        <a href="<?= base_url('Gejala/editGejala/' . $g->kode_gejala); ?>" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Data"><i class="fa fa-edit"></i></a>
                                        <span data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Data">
                                            <a onclick="confirm_modal('<?= base_url('Gejala/deleteGejala/' . $g->kode_gejala); ?>')" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus"><i class="fa fa-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
