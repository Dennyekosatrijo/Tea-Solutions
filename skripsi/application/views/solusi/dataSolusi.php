        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    Tabel Data Solusi
                    <a style="float: right;" href="<?= base_url('Solusi/tambahSolusi'); ?>" class="btn btn-success"><b>Tambah Data</b></a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $s) : ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?= $s->nama_hama; ?></td>
                                    <!-- <td><?= word_limiter($s->slug, 2); ?></td> -->
                                    <td>
                                        <a href="<?= base_url('Solusi/editSolusi/' . $s->slug); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <a href="<?= base_url('Solusi/detailSolusi/' . $s->slug); ?>" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Detail Data"><i class="fa fa-eye"></i></a>
                                        <span data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Data">
                                            <a onclick="confirm_modal('<?= base_url('Solusi/deleteSolusi/' . $s->slug); ?>')" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus"><i class="fa fa-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
