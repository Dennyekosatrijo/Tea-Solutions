    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" method="post" action="<?= base_url('Solusi/simpanEditSolusi/') ?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <h5>Solusi</h5>
                                        <?php foreach ($editall as $e) : ?>
                                            <div class="form-group">
                                            <input type="text" class="form-control form-control-lg" name="kode_solusi[]" value="<?php echo $e->kode_solusi ?>" hidden>
                                             <input type="text" class="form-control form-control-lg" name="solusi[]" placeholder="solusi" value="<?= $e->solusi ?>">
                                            </div>
