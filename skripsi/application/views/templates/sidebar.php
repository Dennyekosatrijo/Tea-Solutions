    ...
    <div id="sidebar" class="active">
        <div class="sidebar-wrapper active">
            <div style="padding-top: 20px; padding-left: 10px;">
                <a style="font-size: xx-large; font-weight: bold; color: #3F9F43;" href="<?= base_url('Dashboard'); ?>"><img width="80px" height="80px" src="<?= base_url('assets/'); ?>images/teh/newlogo.png" alt="Logo" srcset="">Tea Solutions</a>
            </div>
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <?php if ($title == 'Data Hama') : ?>
                        <li class="sidebar-item active has-sub">
                            <a style="background-color: #3F9F43;" href="#" class='sidebar-link'>
                                <i class="bi bi-stack"></i>
                                <span>Hama Tanaman Teh</span>
                            </a>
                            <ul class="submenu active">
                                <li class="submenu-item active">
                                    <a style="color: #3F9F43;" href="<?= base_url('Hama'); ?>">Data Hama</a>
                                </li>
                    ...
                    <?php elseif ($title == 'Data Gejala') : ?>
                        <li class="sidebar-item active  has-sub">
                            ...
                            <ul class="submenu active">
                                <li class="submenu-item ">
                                    <a href="<?= base_url('Hama'); ?>">Data Hama</a>
                                </li>
                                <li class="submenu-item active">
