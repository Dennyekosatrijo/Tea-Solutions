...
<script>
    function tambahsolusi() {
        $("#solusi").append('<div class="col-12"><div class="form-group"><h5>Solusi</h5><textarea name="solusi[]" class="form-control form-control-lg" placeholder="Solusi" value="<?= set_value('solusi'); ?>"></textarea><?= form_error('solusi', '<large class="text-danger pl-3">', '</large>'); ?></div></div>');
    }
</script>
