    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" method="post" action="<?= base_url('BasisPengetahuan/simpanEditBP/' . $edit->kode_pengetahuan) ?>">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        <fieldset class="form-group">
                                            <select class="form-select form-select-lg" id="nama" name="nama">
                                                ...
                                                <?php foreach ($tampil as $hama) : ?>
                                                    <option value="<?= $hama->kode_hama ?>" <?php if ($hama->kode_hama == $edit->kode_hama) echo 'selected'; ?>><?= $hama->nama_hama ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <h5>MB</h5>
                                        <input type="number" step="any" class="form-control form-control-lg" name="mb" placeholder="Nilai MB" value="<?= $edit->nilai_mb ?>">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <h5>MD</h5>
                                        <input type="number" step="any" class="form-control form-control-lg" name="md" placeholder="Nilai MD" value="<?= $edit->nilai_md ?>">
